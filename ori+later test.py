...
class NUTS:
    def __init__(self, target_log_prob_fn, init_state, step_size=0.01, adapt_steps=1500, num_results=1500, max_tree_depth=6, target_accept=0.65):
    ...
    def find_reasonable_epsilon(self, theta):
        ...
        grad = self.grad_log_prob(theta)[1]
        theta_prime, r_prime,_,_ = self.leapfrog(theta, r, grad, step_size)
    ...
    def run_chain(self):
        ...
        step_size = self.find_reasonable_epsilon(current_theta)
